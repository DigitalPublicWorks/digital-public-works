defmodule DigitalPublicWorksWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: DigitalPublicWorksWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/digital_public_works_web/templates",
        namespace: DigitalPublicWorksWeb
      ...
      import DigitalPublicWorksWeb.Permission
      import DigitalPublicWorksWeb.GlobalHelpers
    end
  end
